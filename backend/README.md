...
## Project Structure
    ...
    ├── testapiautoteammemb_96601  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_96601`
...
2. Clone this repo and `cd testapiautoteammemb_96601`
